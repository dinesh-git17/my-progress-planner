...
export default function RecoverDataPage() {
  ...
  return (
    <div className={`min-h-screen w-full ${dmSans.className}`}>
      ...
      <div
        className="min-h-screen bg-gradient-to-br from-[#f5ede6] via-[#f7edf5] to-[#d8d8f0] safe-all flex items-start justify-center p-4"
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/40">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-sm">
                Enter your previous User ID to merge your old meal logs with
              ...
              {recoveryStatus === 'not-found' && (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    We couldn't find any data associated with this User ID.
